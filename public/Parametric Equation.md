A **parametric equation** is a collection of two functions, $x = x(t)$ and $y = y(t)$ of a third variable $t$ called the **parameter** that is defined on the same interval $I$
