To take a partial derivative of a 3-dimensional function $f(x, y)$, constrain one of the variables and take the derivative of the function projected onto that plane (the cross-section)
